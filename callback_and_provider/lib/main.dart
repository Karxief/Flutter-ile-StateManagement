import 'package:callback_and_provider/StateData.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

void main() => runApp(ChangeNotifierProvider(
    create: (BuildContext context) =>
        StateData(), // -> Tüm widget ağacını verilere ulaşabilmek için Provider ile sarmaladık.
    child: MyApp()));
      ...
      child: Column(children: [
        ...
        Text(
          Provider.of<StateData>(context)
              .sehir, // -> Provider kullanarak değişkene erişim sağladık.
          style: TextStyle(fontSize: 20),
        ),
        TextField(
            onChanged: ((value) =>
                Provider.of<StateData>(context, listen: false).newCity(value)))
      ]),
    );
  }
}
